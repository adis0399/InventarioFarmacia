...
import Clases.Cls_BuscarPresentacion;
 ...
 * @author adis0
 */
public class Frm_BuscarPresentacion extends javax.swing.JInternalFrame {
    private final Cls_BuscarPresentacion CP;
    ...
    /**
     * Creates new form Frm_BuscarPresentacion
     */
    public Frm_BuscarPresentacion() {
        initComponents();       
        CP = new Cls_BuscarPresentacion();
        columnModel = tabla.getColumnModel();        
        listar();
    }
    
    private void listar(){
        tabla.setModel(CP.getDatosPresentaciones());
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        if(Frm_Entrada.enviar == 1){
            ...
            int row = tabla.getSelectedRow();            
            Frm_Productos.lblPresentacion.setText(tabla.getValueAt(row, 0).toString());
            Frm_Productos.txtPresentacion.setText(tabla.getValueAt(row, 1).toString());                       
