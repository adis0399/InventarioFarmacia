...
public class Frm_Login extends javax.swing.JFrame {
    ...
    private void loginInventario(){        
        ...
        if (!txt_usuario.getText().equals("") && !pass.equals("")) {
            ...
            if (modSql.login(mod)) {
                ...
                Frm_Principal.frmLog = null;
                this.dispose();
                
                Frm_Principal ing = new Frm_Principal(mod);
                ing.setVisible(true);                
            } else {
                JOptionPane.showMessageDialog(null, "Usuario/Contraseña es incorrecta");
            }
        } else {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Casa_del_alfarero_login.jpg"))); // NOI18N
        jLabel6.setText("jLabel6");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 570, 350, 70));
