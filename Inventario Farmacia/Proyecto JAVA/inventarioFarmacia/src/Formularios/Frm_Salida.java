...
public class Frm_Salida extends javax.swing.JInternalFrame {
    ...
    private void limpiar(){
        ...
        cmb_tipo_salida.setSelectedIndex(0);
        txt_lote.setText("");
        lblCodigo.setText("");
    ...
    private void guardar(){       
        ...
        int tipoSa = 1;
        String salida = cmb_tipo_salida.getSelectedItem().toString();
        
        if (salida.equals("Venta/Muestra")) {
            tipoSa = 1;
        } else {
            tipoSa = 2;
        }
        ...
        int stockLote = CP.verificarStockLote(codigo);
        if(cantidad > stock){
        ...
        if (cantidad > stockLote) {
            JOptionPane.showMessageDialog(null, "¡No hay stock suficiente en el lote!");
            txt_cantidad.setText("");
            txt_cantidad.requestFocus();
        }
            ...
            if(num == 0){
                int respuesta = CP.registrarSalida(lote, nfac, fecha_sql, cantidad, tipoSa);
                if(respuesta > 0){
                    listar();
                    limpiar();
                    iniciar();
    ...
    private void initComponents() {
        ...
        cmb_tipo_salida = new javax.swing.JComboBox<>();
        ...
        cmb_tipo_salida.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Venta/Muestra", "Producto Caducado" }));
        cmb_tipo_salida.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmb_tipo_salidaActionPerformed(evt);
            }
        });

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel8.setText("Tipo de Salida *");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cmb_tipo_salida, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE))))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cmb_tipo_salida, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE)
    ...
    private void jbt_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbt_buscarActionPerformed
        ...
        Frm_BuscarProductoPorEntrada C = new Frm_BuscarProductoPorEntrada();
    ...
    private void cmb_tipo_salidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmb_tipo_salidaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmb_tipo_salidaActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton bt_nuevo;
    private javax.swing.JComboBox<String> cmb_tipo_salida;
    ...
    public static javax.swing.JTextField txt_lote;
