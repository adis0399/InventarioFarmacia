...
import Clases.Cls_DescripcionProducto;
 ...
 * @author adis0
 */
public class Frm_DescripcionProd extends javax.swing.JInternalFrame {

    private final Cls_DescripcionProducto CP;
    TableColumnModel columnModel;
    int num = 0;

    /**
     * Creates new form Frm_DescripcionProd
     */
    public Frm_DescripcionProd() {
        initComponents();
        CP = new Cls_DescripcionProducto();
        columnModel = jtb_des_productos.getColumnModel();
        listar();
        iniciar();
    ...
    private void listar() {
        jtb_des_productos.setModel(CP.getDatosDescripcionProductos());
    ...
    private void limpiar() {
        ...
        txt_codigo.requestFocus();
        jtb_des_productos.clearSelection();
    }

    private void guardar() {        
        String descripcion = txt_descripcion.getText();
        if (descripcion.equals("")) {
            JOptionPane.showMessageDialog(null, "Ingrese un medicamento");
        } else {
            if (num == 0) {
                int respuesta = CP.registrarDescripcionProducto(descripcion);
                if (respuesta > 0) {
                    listar();
                    limpiar();
                    iniciar();
                ...
                int row = jtb_des_productos.getSelectedRow();
                int codigo_old = Integer.parseInt(jtb_des_productos.getValueAt(row, 0).toString());

                int respuesta = CP.actualizarDescripcionProducto(codigo_old, descripcion);
                if (respuesta > 0) {
                    listar();
                    limpiar();
                    iniciar();
    ...
    private void initComponents() {
        ...
        jtb_des_productos = new javax.swing.JTable();
        ...
        jtb_des_productos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jtb_des_productos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtb_des_productosMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jtb_des_productos);
        ...
        jLabel2.setText("Registro Nueva Medicina");

        jLabel3.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        jLabel3.setText("Registre el nombre de la nueva medicina. ");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txt_descripcion, javax.swing.GroupLayout.PREFERRED_SIZE, 744, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jtb_des_productosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtb_des_productosMouseClicked
        bt_actualizar.setEnabled(true);
        bt_eliminar.setEnabled(true);

        int row = jtb_des_productos.getSelectedRow();
        txt_codigo.setText(jtb_des_productos.getValueAt(row, 0).toString());
        txt_descripcion.setText(jtb_des_productos.getValueAt(row, 1).toString());
    }//GEN-LAST:event_jtb_des_productosMouseClicked
    ...
    private void bt_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_eliminarActionPerformed
        int fila = jtb_des_productos.getSelectedRowCount();
        if (fila < 1) {
            ...
            if (resp == 0) {
                if (CP.eliminarDescripcionProducto(jtb_des_productos.getValueAt(jtb_des_productos.getSelectedRow(), 0).toString()) > 0) {
                    listar();
                    limpiar();
                    bt_eliminar.setEnabled(false);
                    bt_actualizar.setEnabled(false);
    ...
    private javax.swing.JTable jtb_des_productos;
