...
public class Cls_BuscarProductos {
    ...
    private final String SQL_SELECT_PRODUCTOS = "SELECT * FROM inventario_general";    
    ...
    public DefaultTableModel getDatoP(int crt, String inf){
        ...
        if (crt==2){
            ...
            SQL = "SELECT * FROM inventario_general WHERE pro_codigo like '"+inf+"%'";
        }
        else {
            ...
            SQL = "SELECT * FROM inventario_general WHERE descripcion_nombre like '%"+inf+"%'";
        }
        try {
            setTitulosProductos();
